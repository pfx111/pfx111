...
# from models.lyz_net import *
import logging
import numpy as np
#from model.attention import CoAtNet
...
parser.add_argument('--fold', type=int, default=9, help="fold")
...
# test id
teidlst = []
for fname in os.listdir('/home/yy/LUNA16/subset' + str(fold) + '/'):
