...
def load_data(test_data_path, preprocess_path, fold, batch_size, num_workers):
    test_data_path = '/home/yy/LUNA16/subset'
    crop_size = 32
    black_list = []

    preprocess_path = '/home/yy/LUNA16'
    pix_value, npix = 0, 0
...
parser.add_argument('--model_path', type=str,default='./checkpoint-0/ckpt.t7',help='ckpt.t7')
parser.add_argument('--fold', type=int, default=9, help='1-5')
parser.add_argument('--batch_size', type=int, default=8)
parser.add_argument('--num_workers', type=int, default=24)
parser.add_argument('--test_data_path', type=str, default='/home/yy/LUNA16/subset')
parser.add_argument('--preprocess_path', type=str, default='/home/yy/LUNA16/cls/crop_v3')
